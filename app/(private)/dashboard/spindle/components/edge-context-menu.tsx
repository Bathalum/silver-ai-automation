...
export function EdgeContextMenu({ position, edgeId, onEdit, onDelete, onClose }: EdgeContextMenuProps) {
  ...
  return (
    ...
    >
      <div className="space-y-1">
        <Button variant="ghost" size="sm" className="w-full justify-start h-8" onClick={() => onEdit(edgeId)}>
